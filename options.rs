pub const RELEASE_DATE: &'static str = "2016-11-22";
...
pub const LATEX: &'static str = "--smart --normalize --standalone --self-contained --highlight-style=tango --chapters --table-of-contents --template=lib/template.tex --latex-engine=lualatex --to=latex";
